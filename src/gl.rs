...
pub unsafe fn ClientWaitSync(
    ...
    >(storage::ClientWaitSync.f)(sync, flags, timeout)
}
#[allow(non_snake_case, unused_variables, dead_code)]
#[inline]
...
pub unsafe fn CreateShaderProgramv(
    ...
    >(storage::CreateShaderProgramv.f)(type_, count, strings)
}
#[allow(non_snake_case, unused_variables, dead_code)]
#[inline]
...
pub unsafe fn FenceSync(condition: types::GLenum, flags: types::GLbitfield) -> types::GLsync {
    ...
    >(storage::FenceSync.f)(condition, flags)
}
#[allow(non_snake_case, unused_variables, dead_code)]
#[inline]
...
pub unsafe fn GetFragDataLocation(
    ...
    __gl_imports::mem::transmute::<
        _,
        extern "system" fn(types::GLuint, *const types::GLchar) -> types::GLint,
    >(storage::GetFragDataLocation.f)(program, name)
}
#[allow(non_snake_case, unused_variables, dead_code)]
#[inline]
...
pub unsafe fn GetProgramResourceIndex(
    ...
    >(storage::GetProgramResourceIndex.f)(program, programInterface, name)
}
#[allow(non_snake_case, unused_variables, dead_code)]
#[inline]
pub unsafe fn GetProgramResourceLocation(
    ...
    >(storage::GetProgramResourceLocation.f)(program, programInterface, name)
}
#[allow(non_snake_case, unused_variables, dead_code)]
#[inline]
...
pub unsafe fn GetStringi(name: types::GLenum, index: types::GLuint) -> *const types::GLubyte {
    ...
    >(storage::GetStringi.f)(name, index)
}
#[allow(non_snake_case, unused_variables, dead_code)]
#[inline]
...
pub unsafe fn GetUniformBlockIndex(
    ...
    >(storage::GetUniformBlockIndex.f)(program, uniformBlockName)
}
#[allow(non_snake_case, unused_variables, dead_code)]
#[inline]
...
pub unsafe fn MapBufferRange(
    ...
    >(storage::MapBufferRange.f)(target, offset, length, access)
}
#[allow(non_snake_case, unused_variables, dead_code)]
#[inline]
...
pub mod ActiveShaderProgram {
    ...
    {
        unsafe {
            storage::ActiveShaderProgram =
                FnPtr::new(metaloadfn(&mut loadfn, "glActiveShaderProgram", &[]))
        }
    }
}
...
pub mod AttachShader {
    ...
    {
        unsafe {
            storage::AttachShader = FnPtr::new(metaloadfn(&mut loadfn, "glAttachShader", &[]))
        }
    }
}
...
pub mod BeginQuery {
    ...
    where
        F: FnMut(&'static str) -> *const raw::c_void,
    {
        unsafe { storage::BeginQuery = FnPtr::new(metaloadfn(&mut loadfn, "glBeginQuery", &[])) }
    }
}
...
pub mod BeginTransformFeedback {
    ...
    {
        unsafe {
            storage::BeginTransformFeedback =
                FnPtr::new(metaloadfn(&mut loadfn, "glBeginTransformFeedback", &[]))
        }
    }
}
...
pub mod BindAttribLocation {
    ...
    {
        unsafe {
            storage::BindAttribLocation =
                FnPtr::new(metaloadfn(&mut loadfn, "glBindAttribLocation", &[]))
        }
    }
}
...
pub mod BindBuffer {
    ...
    where
        F: FnMut(&'static str) -> *const raw::c_void,
    {
        unsafe { storage::BindBuffer = FnPtr::new(metaloadfn(&mut loadfn, "glBindBuffer", &[])) }
    }
}
...
pub mod BindBufferBase {
    ...
    {
        unsafe {
            storage::BindBufferBase = FnPtr::new(metaloadfn(&mut loadfn, "glBindBufferBase", &[]))
        }
    }
}
...
pub mod BindBufferRange {
    ...
    {
        unsafe {
            storage::BindBufferRange = FnPtr::new(metaloadfn(&mut loadfn, "glBindBufferRange", &[]))
        }
    }
}
...
pub mod BindImageTexture {
    ...
    {
        unsafe {
            storage::BindImageTexture =
                FnPtr::new(metaloadfn(&mut loadfn, "glBindImageTexture", &[]))
        }
    }
}
...
pub mod BindProgramPipeline {
    ...
    {
        unsafe {
            storage::BindProgramPipeline =
                FnPtr::new(metaloadfn(&mut loadfn, "glBindProgramPipeline", &[]))
        }
    }
}
...
pub mod BindSampler {
    ...
    where
        F: FnMut(&'static str) -> *const raw::c_void,
    {
        unsafe { storage::BindSampler = FnPtr::new(metaloadfn(&mut loadfn, "glBindSampler", &[])) }
    }
}
...
pub mod BindTexture {
    ...
    where
        F: FnMut(&'static str) -> *const raw::c_void,
    {
        unsafe { storage::BindTexture = FnPtr::new(metaloadfn(&mut loadfn, "glBindTexture", &[])) }
    }
}
...
pub mod BindTransformFeedback {
    ...
    {
        unsafe {
            storage::BindTransformFeedback =
                FnPtr::new(metaloadfn(&mut loadfn, "glBindTransformFeedback", &[]))
        }
    }
}
...
pub mod BindVertexArray {
    ...
    {
        unsafe {
            storage::BindVertexArray = FnPtr::new(metaloadfn(&mut loadfn, "glBindVertexArray", &[]))
        }
    }
}
...
pub mod BindVertexBuffer {
    ...
    {
        unsafe {
            storage::BindVertexBuffer =
                FnPtr::new(metaloadfn(&mut loadfn, "glBindVertexBuffer", &[]))
        }
    }
}
...
pub mod BlendColor {
    ...
    where
        F: FnMut(&'static str) -> *const raw::c_void,
    {
        unsafe { storage::BlendColor = FnPtr::new(metaloadfn(&mut loadfn, "glBlendColor", &[])) }
    }
}
...
pub mod BlendEquation {
    ...
    {
        unsafe {
            storage::BlendEquation = FnPtr::new(metaloadfn(&mut loadfn, "glBlendEquation", &[]))
        }
    }
}
...
pub mod BlendEquationSeparate {
    ...
    {
        unsafe {
            storage::BlendEquationSeparate =
                FnPtr::new(metaloadfn(&mut loadfn, "glBlendEquationSeparate", &[]))
        }
    }
}
        ...
        F: FnMut(&'static str) -> *const raw::c_void,
    {
        unsafe {
            storage::BlendFuncSeparate =
                FnPtr::new(metaloadfn(&mut loadfn, "glBlendFuncSeparate", &[]))
        }
    }
}
...
pub mod BlitFramebuffer {
    ...
    {
        unsafe {
            storage::BlitFramebuffer = FnPtr::new(metaloadfn(&mut loadfn, "glBlitFramebuffer", &[]))
        }
    }
}
...
pub mod BufferData {
    ...
    where
        F: FnMut(&'static str) -> *const raw::c_void,
    {
        unsafe { storage::BufferData = FnPtr::new(metaloadfn(&mut loadfn, "glBufferData", &[])) }
    }
}
...
pub mod CheckFramebufferStatus {
    ...
    {
        unsafe {
            storage::CheckFramebufferStatus =
                FnPtr::new(metaloadfn(&mut loadfn, "glCheckFramebufferStatus", &[]))
        }
    }
}
...
pub mod ClearDepthf {
    ...
    where
        F: FnMut(&'static str) -> *const raw::c_void,
    {
        unsafe { storage::ClearDepthf = FnPtr::new(metaloadfn(&mut loadfn, "glClearDepthf", &[])) }
    }
}
...
pub mod ClientWaitSync {
    ...
    {
        unsafe {
            storage::ClientWaitSync = FnPtr::new(metaloadfn(&mut loadfn, "glClientWaitSync", &[]))
        }
    }
}
...
pub mod CompileShader {
    ...
    {
        unsafe {
            storage::CompileShader = FnPtr::new(metaloadfn(&mut loadfn, "glCompileShader", &[]))
        }
    }
}
...
pub mod CompressedTexImage2D {
    ...
    {
        unsafe {
            storage::CompressedTexImage2D =
                FnPtr::new(metaloadfn(&mut loadfn, "glCompressedTexImage2D", &[]))
        }
    }
}
...
pub mod CompressedTexImage3D {
    ...
    {
        unsafe {
            storage::CompressedTexImage3D =
                FnPtr::new(metaloadfn(&mut loadfn, "glCompressedTexImage3D", &[]))
        }
    }
}
...
pub mod CompressedTexSubImage2D {
    ...
    {
        unsafe {
            storage::CompressedTexSubImage2D =
                FnPtr::new(metaloadfn(&mut loadfn, "glCompressedTexSubImage2D", &[]))
        }
    }
}
...
pub mod CompressedTexSubImage3D {
    ...
    {
        unsafe {
            storage::CompressedTexSubImage3D =
                FnPtr::new(metaloadfn(&mut loadfn, "glCompressedTexSubImage3D", &[]))
        }
    }
}
...
pub mod CopyBufferSubData {
    ...
    {
        unsafe {
            storage::CopyBufferSubData =
                FnPtr::new(metaloadfn(&mut loadfn, "glCopyBufferSubData", &[]))
        }
    }
}
...
pub mod CopyTexSubImage2D {
    ...
    {
        unsafe {
            storage::CopyTexSubImage2D =
                FnPtr::new(metaloadfn(&mut loadfn, "glCopyTexSubImage2D", &[]))
        }
    }
}
...
pub mod CopyTexSubImage3D {
    ...
    {
        unsafe {
            storage::CopyTexSubImage3D =
                FnPtr::new(metaloadfn(&mut loadfn, "glCopyTexSubImage3D", &[]))
        }
    }
}
...
pub mod CreateProgram {
    ...
    {
        unsafe {
            storage::CreateProgram = FnPtr::new(metaloadfn(&mut loadfn, "glCreateProgram", &[]))
        }
    }
}
...
pub mod CreateShader {
    ...
    {
        unsafe {
            storage::CreateShader = FnPtr::new(metaloadfn(&mut loadfn, "glCreateShader", &[]))
        }
    }
}
...
pub mod CreateShaderProgramv {
    ...
    {
        unsafe {
            storage::CreateShaderProgramv =
                FnPtr::new(metaloadfn(&mut loadfn, "glCreateShaderProgramv", &[]))
        }
    }
}
...
pub mod DeleteFramebuffers {
    ...
    {
        unsafe {
            storage::DeleteFramebuffers =
                FnPtr::new(metaloadfn(&mut loadfn, "glDeleteFramebuffers", &[]))
        }
    }
}
...
pub mod DeleteProgramPipelines {
    ...
    {
        unsafe {
            storage::DeleteProgramPipelines =
                FnPtr::new(metaloadfn(&mut loadfn, "glDeleteProgramPipelines", &[]))
        }
    }
}
...
pub mod DeleteQueries {
    ...
    {
        unsafe {
            storage::DeleteQueries = FnPtr::new(metaloadfn(&mut loadfn, "glDeleteQueries", &[]))
        }
    }
}
...
pub mod DeleteRenderbuffers {
    ...
    {
        unsafe {
            storage::DeleteRenderbuffers =
                FnPtr::new(metaloadfn(&mut loadfn, "glDeleteRenderbuffers", &[]))
        }
    }
}
...
pub mod DeleteSync {
    ...
    where
        F: FnMut(&'static str) -> *const raw::c_void,
    {
        unsafe { storage::DeleteSync = FnPtr::new(metaloadfn(&mut loadfn, "glDeleteSync", &[])) }
    }
}
...
pub mod DeleteTransformFeedbacks {
    ...
    {
        unsafe {
            storage::DeleteTransformFeedbacks =
                FnPtr::new(metaloadfn(&mut loadfn, "glDeleteTransformFeedbacks", &[]))
        }
    }
}
...
pub mod DeleteVertexArrays {
    ...
    {
        unsafe {
            storage::DeleteVertexArrays =
                FnPtr::new(metaloadfn(&mut loadfn, "glDeleteVertexArrays", &[]))
        }
    }
}
...
pub mod DepthRangef {
    ...
    where
        F: FnMut(&'static str) -> *const raw::c_void,
    {
        unsafe { storage::DepthRangef = FnPtr::new(metaloadfn(&mut loadfn, "glDepthRangef", &[])) }
    }
}
...
pub mod DetachShader {
    ...
    {
        unsafe {
            storage::DetachShader = FnPtr::new(metaloadfn(&mut loadfn, "glDetachShader", &[]))
        }
    }
}
...
pub mod DisableVertexAttribArray {
    ...
    {
        unsafe {
            storage::DisableVertexAttribArray =
                FnPtr::new(metaloadfn(&mut loadfn, "glDisableVertexAttribArray", &[]))
        }
    }
}
...
pub mod DispatchComputeIndirect {
    ...
    {
        unsafe {
            storage::DispatchComputeIndirect =
                FnPtr::new(metaloadfn(&mut loadfn, "glDispatchComputeIndirect", &[]))
        }
    }
}
...
pub mod DrawArrays {
    ...
    where
        F: FnMut(&'static str) -> *const raw::c_void,
    {
        unsafe { storage::DrawArrays = FnPtr::new(metaloadfn(&mut loadfn, "glDrawArrays", &[])) }
    }
}
...
pub mod DrawArraysIndirect {
    ...
    {
        unsafe {
            storage::DrawArraysIndirect =
                FnPtr::new(metaloadfn(&mut loadfn, "glDrawArraysIndirect", &[]))
        }
    }
}
...
pub mod DrawArraysInstanced {
    ...
    {
        unsafe {
            storage::DrawArraysInstanced =
                FnPtr::new(metaloadfn(&mut loadfn, "glDrawArraysInstanced", &[]))
        }
    }
}
...
pub mod DrawBuffers {
    ...
    where
        F: FnMut(&'static str) -> *const raw::c_void,
    {
        unsafe { storage::DrawBuffers = FnPtr::new(metaloadfn(&mut loadfn, "glDrawBuffers", &[])) }
    }
}
...
pub mod DrawElementsIndirect {
    ...
    {
        unsafe {
            storage::DrawElementsIndirect =
                FnPtr::new(metaloadfn(&mut loadfn, "glDrawElementsIndirect", &[]))
        }
    }
}
...
pub mod DrawRangeElements {
    ...
    {
        unsafe {
            storage::DrawRangeElements =
                FnPtr::new(metaloadfn(&mut loadfn, "glDrawRangeElements", &[]))
        }
    }
}
...
pub mod EnableVertexAttribArray {
    ...
    {
        unsafe {
            storage::EnableVertexAttribArray =
                FnPtr::new(metaloadfn(&mut loadfn, "glEnableVertexAttribArray", &[]))
        }
    }
}
...
pub mod EndQuery {
    ...
    where
        F: FnMut(&'static str) -> *const raw::c_void,
    {
        unsafe { storage::EndQuery = FnPtr::new(metaloadfn(&mut loadfn, "glEndQuery", &[])) }
    }
}
...
pub mod EndTransformFeedback {
    ...
    {
        unsafe {
            storage::EndTransformFeedback =
                FnPtr::new(metaloadfn(&mut loadfn, "glEndTransformFeedback", &[]))
        }
    }
}
...
pub mod FenceSync {
    ...
    where
        F: FnMut(&'static str) -> *const raw::c_void,
    {
        unsafe { storage::FenceSync = FnPtr::new(metaloadfn(&mut loadfn, "glFenceSync", &[])) }
    }
}
...
pub mod FlushMappedBufferRange {
    ...
    {
        unsafe {
            storage::FlushMappedBufferRange =
                FnPtr::new(metaloadfn(&mut loadfn, "glFlushMappedBufferRange", &[]))
        }
    }
}
...
pub mod FramebufferParameteri {
    ...
    {
        unsafe {
            storage::FramebufferParameteri =
                FnPtr::new(metaloadfn(&mut loadfn, "glFramebufferParameteri", &[]))
        }
    }
}
...
pub mod FramebufferRenderbuffer {
    ...
    {
        unsafe {
            storage::FramebufferRenderbuffer =
                FnPtr::new(metaloadfn(&mut loadfn, "glFramebufferRenderbuffer", &[]))
        }
    }
}
...
pub mod FramebufferTexture2D {
    ...
    {
        unsafe {
            storage::FramebufferTexture2D =
                FnPtr::new(metaloadfn(&mut loadfn, "glFramebufferTexture2D", &[]))
        }
    }
}
...
pub mod FramebufferTextureLayer {
    ...
    {
        unsafe {
            storage::FramebufferTextureLayer =
                FnPtr::new(metaloadfn(&mut loadfn, "glFramebufferTextureLayer", &[]))
        }
    }
}
...
pub mod GenBuffers {
    ...
    where
        F: FnMut(&'static str) -> *const raw::c_void,
    {
        unsafe { storage::GenBuffers = FnPtr::new(metaloadfn(&mut loadfn, "glGenBuffers", &[])) }
    }
}
...
pub mod GenFramebuffers {
    ...
    {
        unsafe {
            storage::GenFramebuffers = FnPtr::new(metaloadfn(&mut loadfn, "glGenFramebuffers", &[]))
        }
    }
}
...
pub mod GenProgramPipelines {
    ...
    {
        unsafe {
            storage::GenProgramPipelines =
                FnPtr::new(metaloadfn(&mut loadfn, "glGenProgramPipelines", &[]))
        }
    }
}
...
pub mod GenQueries {
    ...
    where
        F: FnMut(&'static str) -> *const raw::c_void,
    {
        unsafe { storage::GenQueries = FnPtr::new(metaloadfn(&mut loadfn, "glGenQueries", &[])) }
    }
}
...
pub mod GenRenderbuffers {
    ...
    {
        unsafe {
            storage::GenRenderbuffers =
                FnPtr::new(metaloadfn(&mut loadfn, "glGenRenderbuffers", &[]))
        }
    }
}
...
pub mod GenSamplers {
    ...
    where
        F: FnMut(&'static str) -> *const raw::c_void,
    {
        unsafe { storage::GenSamplers = FnPtr::new(metaloadfn(&mut loadfn, "glGenSamplers", &[])) }
    }
}
...
pub mod GenTransformFeedbacks {
    ...
    {
        unsafe {
            storage::GenTransformFeedbacks =
                FnPtr::new(metaloadfn(&mut loadfn, "glGenTransformFeedbacks", &[]))
        }
    }
}
...
pub mod GenVertexArrays {
    ...
    {
        unsafe {
            storage::GenVertexArrays = FnPtr::new(metaloadfn(&mut loadfn, "glGenVertexArrays", &[]))
        }
    }
}
...
pub mod GetActiveAttrib {
    ...
    {
        unsafe {
            storage::GetActiveAttrib = FnPtr::new(metaloadfn(&mut loadfn, "glGetActiveAttrib", &[]))
        }
    }
}
...
pub mod GetActiveUniformBlockName {
    ...
    {
        unsafe {
            storage::GetActiveUniformBlockName =
                FnPtr::new(metaloadfn(&mut loadfn, "glGetActiveUniformBlockName", &[]))
        }
    }
}
...
pub mod GetActiveUniformBlockiv {
    ...
    {
        unsafe {
            storage::GetActiveUniformBlockiv =
                FnPtr::new(metaloadfn(&mut loadfn, "glGetActiveUniformBlockiv", &[]))
        }
    }
}
...
pub mod GetActiveUniformsiv {
    ...
    {
        unsafe {
            storage::GetActiveUniformsiv =
                FnPtr::new(metaloadfn(&mut loadfn, "glGetActiveUniformsiv", &[]))
        }
    }
}
        ...
        F: FnMut(&'static str) -> *const raw::c_void,
    {
        unsafe {
            storage::GetAttribLocation =
                FnPtr::new(metaloadfn(&mut loadfn, "glGetAttribLocation", &[]))
        }
    }
}
...
pub mod GetBooleani_v {
    ...
    {
        unsafe {
            storage::GetBooleani_v = FnPtr::new(metaloadfn(&mut loadfn, "glGetBooleani_v", &[]))
        }
    }
}
...
pub mod GetBufferParameteri64v {
    ...
    {
        unsafe {
            storage::GetBufferParameteri64v =
                FnPtr::new(metaloadfn(&mut loadfn, "glGetBufferParameteri64v", &[]))
        }
    }
}
...
pub mod GetBufferParameteriv {
    ...
    {
        unsafe {
            storage::GetBufferParameteriv =
                FnPtr::new(metaloadfn(&mut loadfn, "glGetBufferParameteriv", &[]))
        }
    }
}
...
pub mod GetBufferPointerv {
    ...
    {
        unsafe {
            storage::GetBufferPointerv =
                FnPtr::new(metaloadfn(&mut loadfn, "glGetBufferPointerv", &[]))
        }
    }
}
...
pub mod GetFragDataLocation {
    ...
    {
        unsafe {
            storage::GetFragDataLocation =
                FnPtr::new(metaloadfn(&mut loadfn, "glGetFragDataLocation", &[]))
        }
    }
}
...
pub mod GetFramebufferParameteriv {
    ...
    {
        unsafe {
            storage::GetFramebufferParameteriv =
                FnPtr::new(metaloadfn(&mut loadfn, "glGetFramebufferParameteriv", &[]))
        }
    }
}
...
pub mod GetInteger64v {
    ...
    {
        unsafe {
            storage::GetInteger64v = FnPtr::new(metaloadfn(&mut loadfn, "glGetInteger64v", &[]))
        }
    }
}
...
pub mod GetIntegeri_v {
    ...
    {
        unsafe {
            storage::GetIntegeri_v = FnPtr::new(metaloadfn(&mut loadfn, "glGetIntegeri_v", &[]))
        }
    }
}
...
pub mod GetInternalformativ {
    ...
    {
        unsafe {
            storage::GetInternalformativ =
                FnPtr::new(metaloadfn(&mut loadfn, "glGetInternalformativ", &[]))
        }
    }
}
...
pub mod GetMultisamplefv {
    ...
    {
        unsafe {
            storage::GetMultisamplefv =
                FnPtr::new(metaloadfn(&mut loadfn, "glGetMultisamplefv", &[]))
        }
    }
}
...
pub mod GetProgramBinary {
    ...
    {
        unsafe {
            storage::GetProgramBinary =
                FnPtr::new(metaloadfn(&mut loadfn, "glGetProgramBinary", &[]))
        }
    }
}
...
pub mod GetProgramInterfaceiv {
    ...
    {
        unsafe {
            storage::GetProgramInterfaceiv =
                FnPtr::new(metaloadfn(&mut loadfn, "glGetProgramInterfaceiv", &[]))
        }
    }
}
...
pub mod GetProgramPipelineInfoLog {
    ...
    {
        unsafe {
            storage::GetProgramPipelineInfoLog =
                FnPtr::new(metaloadfn(&mut loadfn, "glGetProgramPipelineInfoLog", &[]))
        }
    }
}
...
pub mod GetProgramPipelineiv {
    ...
    {
        unsafe {
            storage::GetProgramPipelineiv =
                FnPtr::new(metaloadfn(&mut loadfn, "glGetProgramPipelineiv", &[]))
        }
    }
}
...
pub mod GetProgramResourceIndex {
    ...
    {
        unsafe {
            storage::GetProgramResourceIndex =
                FnPtr::new(metaloadfn(&mut loadfn, "glGetProgramResourceIndex", &[]))
        }
    }
}
...
pub mod GetProgramResourceLocation {
    ...
    {
        unsafe {
            storage::GetProgramResourceLocation =
                FnPtr::new(metaloadfn(&mut loadfn, "glGetProgramResourceLocation", &[]))
        }
    }
}
...
pub mod GetProgramResourceName {
    ...
    {
        unsafe {
            storage::GetProgramResourceName =
                FnPtr::new(metaloadfn(&mut loadfn, "glGetProgramResourceName", &[]))
        }
    }
}
...
pub mod GetProgramResourceiv {
    ...
    {
        unsafe {
            storage::GetProgramResourceiv =
                FnPtr::new(metaloadfn(&mut loadfn, "glGetProgramResourceiv", &[]))
        }
    }
}
...
pub mod GetQueryObjectuiv {
    ...
    {
        unsafe {
            storage::GetQueryObjectuiv =
                FnPtr::new(metaloadfn(&mut loadfn, "glGetQueryObjectuiv", &[]))
        }
    }
}
...
pub mod GetQueryiv {
    ...
    where
        F: FnMut(&'static str) -> *const raw::c_void,
    {
        unsafe { storage::GetQueryiv = FnPtr::new(metaloadfn(&mut loadfn, "glGetQueryiv", &[])) }
    }
}
...
pub mod GetRenderbufferParameteriv {
    ...
    {
        unsafe {
            storage::GetRenderbufferParameteriv =
                FnPtr::new(metaloadfn(&mut loadfn, "glGetRenderbufferParameteriv", &[]))
        }
    }
}
...
pub mod GetSamplerParameterfv {
    ...
    {
        unsafe {
            storage::GetSamplerParameterfv =
                FnPtr::new(metaloadfn(&mut loadfn, "glGetSamplerParameterfv", &[]))
        }
    }
}
...
pub mod GetSamplerParameteriv {
    ...
    {
        unsafe {
            storage::GetSamplerParameteriv =
                FnPtr::new(metaloadfn(&mut loadfn, "glGetSamplerParameteriv", &[]))
        }
    }
}
...
pub mod GetShaderSource {
    ...
    {
        unsafe {
            storage::GetShaderSource = FnPtr::new(metaloadfn(&mut loadfn, "glGetShaderSource", &[]))
        }
    }
}
...
pub mod GetStringi {
    ...
    where
        F: FnMut(&'static str) -> *const raw::c_void,
    {
        unsafe { storage::GetStringi = FnPtr::new(metaloadfn(&mut loadfn, "glGetStringi", &[])) }
    }
}
...
pub mod GetSynciv {
    ...
    where
        F: FnMut(&'static str) -> *const raw::c_void,
    {
        unsafe { storage::GetSynciv = FnPtr::new(metaloadfn(&mut loadfn, "glGetSynciv", &[])) }
    }
}
...
pub mod GetTexLevelParameterfv {
    ...
    {
        unsafe {
            storage::GetTexLevelParameterfv =
                FnPtr::new(metaloadfn(&mut loadfn, "glGetTexLevelParameterfv", &[]))
        }
    }
}
...
pub mod GetTexLevelParameteriv {
    ...
    {
        unsafe {
            storage::GetTexLevelParameteriv =
...
pub mod GetTransformFeedbackVarying {
    ...
    {
        unsafe {
            storage::GetTransformFeedbackVarying = FnPtr::new(metaloadfn(
                &mut loadfn,
...
pub mod GetUniformIndices {
    ...
    {
        unsafe {
            storage::GetUniformIndices =
                FnPtr::new(metaloadfn(&mut loadfn, "glGetUniformIndices", &[]))
        }
    }
}
...
pub mod GetUniformLocation {
    ...
    {
        unsafe {
            storage::GetUniformLocation =
                FnPtr::new(metaloadfn(&mut loadfn, "glGetUniformLocation", &[]))
        }
    }
}
...
pub mod GetUniformfv {
    ...
    {
        unsafe {
            storage::GetUniformfv = FnPtr::new(metaloadfn(&mut loadfn, "glGetUniformfv", &[]))
        }
    }
}
...
pub mod GetUniformiv {
    ...
    {
        unsafe {
            storage::GetUniformiv = FnPtr::new(metaloadfn(&mut loadfn, "glGetUniformiv", &[]))
        }
    }
}
...
pub mod GetUniformuiv {
    ...
    {
        unsafe {
            storage::GetUniformuiv = FnPtr::new(metaloadfn(&mut loadfn, "glGetUniformuiv", &[]))
        }
    }
}
...
pub mod GetVertexAttribIiv {
    ...
    {
        unsafe {
            storage::GetVertexAttribIiv =
                FnPtr::new(metaloadfn(&mut loadfn, "glGetVertexAttribIiv", &[]))
        }
    }
}
...
pub mod GetVertexAttribIuiv {
    ...
    {
        unsafe {
            storage::GetVertexAttribIuiv =
                FnPtr::new(metaloadfn(&mut loadfn, "glGetVertexAttribIuiv", &[]))
        }
    }
}
...
pub mod GetVertexAttribPointerv {
    ...
    {
        unsafe {
            storage::GetVertexAttribPointerv =
                FnPtr::new(metaloadfn(&mut loadfn, "glGetVertexAttribPointerv", &[]))
        }
    }
}
...
pub mod GetVertexAttribfv {
    ...
    {
        unsafe {
            storage::GetVertexAttribfv =
                FnPtr::new(metaloadfn(&mut loadfn, "glGetVertexAttribfv", &[]))
        }
    }
}
...
pub mod GetVertexAttribiv {
    ...
    {
        unsafe {
            storage::GetVertexAttribiv =
                FnPtr::new(metaloadfn(&mut loadfn, "glGetVertexAttribiv", &[]))
        }
    }
}
...
pub mod InvalidateFramebuffer {
    ...
    {
        unsafe {
            storage::InvalidateFramebuffer =
                FnPtr::new(metaloadfn(&mut loadfn, "glInvalidateFramebuffer", &[]))
        }
    }
}
...
pub mod InvalidateSubFramebuffer {
    ...
    {
        unsafe {
            storage::InvalidateSubFramebuffer =
                FnPtr::new(metaloadfn(&mut loadfn, "glInvalidateSubFramebuffer", &[]))
        }
    }
}
...
pub mod IsBuffer {
    ...
    where
        F: FnMut(&'static str) -> *const raw::c_void,
    {
        unsafe { storage::IsBuffer = FnPtr::new(metaloadfn(&mut loadfn, "glIsBuffer", &[])) }
    }
}
...
pub mod IsFramebuffer {
    ...
    {
        unsafe {
            storage::IsFramebuffer = FnPtr::new(metaloadfn(&mut loadfn, "glIsFramebuffer", &[]))
        }
    }
}
...
pub mod IsProgramPipeline {
    ...
    {
        unsafe {
            storage::IsProgramPipeline =
                FnPtr::new(metaloadfn(&mut loadfn, "glIsProgramPipeline", &[]))
        }
    }
}
...
pub mod IsQuery {
    ...
    where
        F: FnMut(&'static str) -> *const raw::c_void,
    {
        unsafe { storage::IsQuery = FnPtr::new(metaloadfn(&mut loadfn, "glIsQuery", &[])) }
    }
}
...
pub mod IsRenderbuffer {
    ...
    {
        unsafe {
            storage::IsRenderbuffer = FnPtr::new(metaloadfn(&mut loadfn, "glIsRenderbuffer", &[]))
        }
    }
}
...
pub mod IsSampler {
    ...
    where
        F: FnMut(&'static str) -> *const raw::c_void,
    {
        unsafe { storage::IsSampler = FnPtr::new(metaloadfn(&mut loadfn, "glIsSampler", &[])) }
    }
}
...
pub mod IsSync {
    ...
    where
        F: FnMut(&'static str) -> *const raw::c_void,
    {
        unsafe { storage::IsSync = FnPtr::new(metaloadfn(&mut loadfn, "glIsSync", &[])) }
    }
}
...
pub mod IsTransformFeedback {
    ...
    {
        unsafe {
            storage::IsTransformFeedback =
                FnPtr::new(metaloadfn(&mut loadfn, "glIsTransformFeedback", &[]))
        }
    }
}
...
pub mod IsVertexArray {
    ...
    {
        unsafe {
            storage::IsVertexArray = FnPtr::new(metaloadfn(&mut loadfn, "glIsVertexArray", &[]))
        }
    }
}
...
pub mod LinkProgram {
    ...
    where
        F: FnMut(&'static str) -> *const raw::c_void,
    {
        unsafe { storage::LinkProgram = FnPtr::new(metaloadfn(&mut loadfn, "glLinkProgram", &[])) }
    }
}
...
pub mod MapBufferRange {
    ...
    {
        unsafe {
            storage::MapBufferRange = FnPtr::new(metaloadfn(&mut loadfn, "glMapBufferRange", &[]))
        }
    }
}
...
pub mod MemoryBarrier {
    ...
    {
        unsafe {
            storage::MemoryBarrier = FnPtr::new(metaloadfn(&mut loadfn, "glMemoryBarrier", &[]))
        }
    }
}
...
pub mod MemoryBarrierByRegion {
    ...
    {
        unsafe {
            storage::MemoryBarrierByRegion =
                FnPtr::new(metaloadfn(&mut loadfn, "glMemoryBarrierByRegion", &[]))
        }
    }
}
...
pub mod PauseTransformFeedback {
    ...
    {
        unsafe {
            storage::PauseTransformFeedback =
                FnPtr::new(metaloadfn(&mut loadfn, "glPauseTransformFeedback", &[]))
        }
    }
}
...
pub mod ProgramBinary {
    ...
    {
        unsafe {
            storage::ProgramBinary = FnPtr::new(metaloadfn(&mut loadfn, "glProgramBinary", &[]))
        }
    }
}
...
pub mod ProgramParameteri {
    ...
    {
        unsafe {
            storage::ProgramParameteri =
                FnPtr::new(metaloadfn(&mut loadfn, "glProgramParameteri", &[]))
        }
    }
}
...
pub mod ProgramUniform1f {
    ...
    {
        unsafe {
            storage::ProgramUniform1f =
                FnPtr::new(metaloadfn(&mut loadfn, "glProgramUniform1f", &[]))
        }
    }
}
...
pub mod ProgramUniform1fv {
    ...
    {
        unsafe {
            storage::ProgramUniform1fv =
                FnPtr::new(metaloadfn(&mut loadfn, "glProgramUniform1fv", &[]))
        }
    }
}
...
pub mod ProgramUniform1i {
    ...
    {
        unsafe {
            storage::ProgramUniform1i =
                FnPtr::new(metaloadfn(&mut loadfn, "glProgramUniform1i", &[]))
        }
    }
}
...
pub mod ProgramUniform1iv {
    ...
    {
        unsafe {
            storage::ProgramUniform1iv =
                FnPtr::new(metaloadfn(&mut loadfn, "glProgramUniform1iv", &[]))
        }
    }
}
...
pub mod ProgramUniform1ui {
    ...
    {
        unsafe {
            storage::ProgramUniform1ui =
                FnPtr::new(metaloadfn(&mut loadfn, "glProgramUniform1ui", &[]))
        }
    }
}
...
pub mod ProgramUniform1uiv {
    ...
    {
        unsafe {
            storage::ProgramUniform1uiv =
                FnPtr::new(metaloadfn(&mut loadfn, "glProgramUniform1uiv", &[]))
        }
    }
}
...
pub mod ProgramUniform2f {
    ...
    {
        unsafe {
            storage::ProgramUniform2f =
                FnPtr::new(metaloadfn(&mut loadfn, "glProgramUniform2f", &[]))
        }
    }
}
...
pub mod ProgramUniform2fv {
    ...
    {
        unsafe {
            storage::ProgramUniform2fv =
                FnPtr::new(metaloadfn(&mut loadfn, "glProgramUniform2fv", &[]))
        }
    }
}
...
pub mod ProgramUniform2i {
    ...
    {
        unsafe {
            storage::ProgramUniform2i =
                FnPtr::new(metaloadfn(&mut loadfn, "glProgramUniform2i", &[]))
        }
    }
}
...
pub mod ProgramUniform2iv {
    ...
    {
        unsafe {
            storage::ProgramUniform2iv =
                FnPtr::new(metaloadfn(&mut loadfn, "glProgramUniform2iv", &[]))
        }
    }
}
...
pub mod ProgramUniform2ui {
    ...
    {
        unsafe {
            storage::ProgramUniform2ui =
                FnPtr::new(metaloadfn(&mut loadfn, "glProgramUniform2ui", &[]))
        }
    }
}
...
pub mod ProgramUniform2uiv {
    ...
    {
        unsafe {
            storage::ProgramUniform2uiv =
                FnPtr::new(metaloadfn(&mut loadfn, "glProgramUniform2uiv", &[]))
        }
    }
}
...
pub mod ProgramUniform3f {
    ...
    {
        unsafe {
            storage::ProgramUniform3f =
                FnPtr::new(metaloadfn(&mut loadfn, "glProgramUniform3f", &[]))
        }
    }
}
...
pub mod ProgramUniform3fv {
    ...
    {
        unsafe {
            storage::ProgramUniform3fv =
                FnPtr::new(metaloadfn(&mut loadfn, "glProgramUniform3fv", &[]))
        }
    }
}
...
pub mod ProgramUniform3i {
    ...
    {
        unsafe {
            storage::ProgramUniform3i =
                FnPtr::new(metaloadfn(&mut loadfn, "glProgramUniform3i", &[]))
        }
    }
}
...
pub mod ProgramUniform3iv {
    ...
    {
        unsafe {
            storage::ProgramUniform3iv =
                FnPtr::new(metaloadfn(&mut loadfn, "glProgramUniform3iv", &[]))
        }
    }
}
...
pub mod ProgramUniform3ui {
    ...
    {
        unsafe {
            storage::ProgramUniform3ui =
                FnPtr::new(metaloadfn(&mut loadfn, "glProgramUniform3ui", &[]))
        }
    }
}
...
pub mod ProgramUniform3uiv {
    ...
    {
        unsafe {
            storage::ProgramUniform3uiv =
                FnPtr::new(metaloadfn(&mut loadfn, "glProgramUniform3uiv", &[]))
        }
    }
}
...
pub mod ProgramUniform4f {
    ...
    {
        unsafe {
            storage::ProgramUniform4f =
                FnPtr::new(metaloadfn(&mut loadfn, "glProgramUniform4f", &[]))
        }
    }
}
...
pub mod ProgramUniform4fv {
    ...
    {
        unsafe {
            storage::ProgramUniform4fv =
                FnPtr::new(metaloadfn(&mut loadfn, "glProgramUniform4fv", &[]))
        }
    }
}
...
pub mod ProgramUniform4i {
    ...
    {
        unsafe {
            storage::ProgramUniform4i =
                FnPtr::new(metaloadfn(&mut loadfn, "glProgramUniform4i", &[]))
        }
    }
}
...
pub mod ProgramUniform4iv {
    ...
    {
        unsafe {
            storage::ProgramUniform4iv =
                FnPtr::new(metaloadfn(&mut loadfn, "glProgramUniform4iv", &[]))
        }
    }
}
...
pub mod ProgramUniform4ui {
    ...
    {
        unsafe {
            storage::ProgramUniform4ui =
                FnPtr::new(metaloadfn(&mut loadfn, "glProgramUniform4ui", &[]))
        }
    }
}
...
pub mod ProgramUniform4uiv {
    ...
    {
        unsafe {
            storage::ProgramUniform4uiv =
                FnPtr::new(metaloadfn(&mut loadfn, "glProgramUniform4uiv", &[]))
        }
    }
}
...
pub mod ProgramUniformMatrix2fv {
    ...
    {
        unsafe {
            storage::ProgramUniformMatrix2fv =
                FnPtr::new(metaloadfn(&mut loadfn, "glProgramUniformMatrix2fv", &[]))
        }
    }
}
...
pub mod ProgramUniformMatrix2x3fv {
    ...
    {
        unsafe {
            storage::ProgramUniformMatrix2x3fv =
                FnPtr::new(metaloadfn(&mut loadfn, "glProgramUniformMatrix2x3fv", &[]))
        }
    }
}
...
pub mod ProgramUniformMatrix2x4fv {
    ...
    {
        unsafe {
            storage::ProgramUniformMatrix2x4fv =
                FnPtr::new(metaloadfn(&mut loadfn, "glProgramUniformMatrix2x4fv", &[]))
        }
    }
}
...
pub mod ProgramUniformMatrix3fv {
    ...
    {
        unsafe {
            storage::ProgramUniformMatrix3fv =
                FnPtr::new(metaloadfn(&mut loadfn, "glProgramUniformMatrix3fv", &[]))
        }
    }
}
...
pub mod ProgramUniformMatrix3x2fv {
    ...
    {
        unsafe {
            storage::ProgramUniformMatrix3x2fv =
                FnPtr::new(metaloadfn(&mut loadfn, "glProgramUniformMatrix3x2fv", &[]))
        }
    }
}
...
pub mod ProgramUniformMatrix3x4fv {
    ...
    {
        unsafe {
            storage::ProgramUniformMatrix3x4fv =
...
pub mod ProgramUniformMatrix4fv {
    ...
    {
        unsafe {
            storage::ProgramUniformMatrix4fv =
                FnPtr::new(metaloadfn(&mut loadfn, "glProgramUniformMatrix4fv", &[]))
        }
    }
}
        ...
        F: FnMut(&'static str) -> *const raw::c_void,
    {
        unsafe {
            storage::ProgramUniformMatrix4x2fv =
                FnPtr::new(metaloadfn(&mut loadfn, "glProgramUniformMatrix4x2fv", &[]))
        }
    }
}
...
pub mod ProgramUniformMatrix4x3fv {
    ...
    {
        unsafe {
            storage::ProgramUniformMatrix4x3fv =
                FnPtr::new(metaloadfn(&mut loadfn, "glProgramUniformMatrix4x3fv", &[]))
        }
    }
}
...
pub mod ReadBuffer {
    ...
    where
        F: FnMut(&'static str) -> *const raw::c_void,
    {
        unsafe { storage::ReadBuffer = FnPtr::new(metaloadfn(&mut loadfn, "glReadBuffer", &[])) }
    }
}
        ...
        F: FnMut(&'static str) -> *const raw::c_void,
    {
        unsafe {
            storage::RenderbufferStorage =
                FnPtr::new(metaloadfn(&mut loadfn, "glRenderbufferStorage", &[]))
        }
    }
}
...
pub mod RenderbufferStorageMultisample {
    ...
    {
        unsafe {
            storage::RenderbufferStorageMultisample = FnPtr::new(metaloadfn(
                &mut loadfn,
...
pub mod ResumeTransformFeedback {
    ...
    {
        unsafe {
            storage::ResumeTransformFeedback =
                FnPtr::new(metaloadfn(&mut loadfn, "glResumeTransformFeedback", &[]))
        }
    }
}
...
pub mod SampleMaski {
    ...
    where
        F: FnMut(&'static str) -> *const raw::c_void,
    {
        unsafe { storage::SampleMaski = FnPtr::new(metaloadfn(&mut loadfn, "glSampleMaski", &[])) }
    }
}
...
pub mod SamplerParameterf {
    ...
    {
        unsafe {
            storage::SamplerParameterf =
                FnPtr::new(metaloadfn(&mut loadfn, "glSamplerParameterf", &[]))
        }
    }
}
...
pub mod SamplerParameterfv {
    ...
    {
        unsafe {
            storage::SamplerParameterfv =
                FnPtr::new(metaloadfn(&mut loadfn, "glSamplerParameterfv", &[]))
        }
    }
}
...
pub mod SamplerParameteri {
    ...
    {
        unsafe {
            storage::SamplerParameteri =
                FnPtr::new(metaloadfn(&mut loadfn, "glSamplerParameteri", &[]))
        }
    }
}
...
pub mod SamplerParameteriv {
    ...
    {
        unsafe {
            storage::SamplerParameteriv =
                FnPtr::new(metaloadfn(&mut loadfn, "glSamplerParameteriv", &[]))
        }
    }
}
...
pub mod ShaderSource {
    ...
    {
        unsafe {
            storage::ShaderSource = FnPtr::new(metaloadfn(&mut loadfn, "glShaderSource", &[]))
        }
    }
}
...
pub mod StencilOpSeparate {
    ...
    {
        unsafe {
            storage::StencilOpSeparate =
                FnPtr::new(metaloadfn(&mut loadfn, "glStencilOpSeparate", &[]))
        }
    }
}
...
pub mod TexImage3D {
    ...
    where
        F: FnMut(&'static str) -> *const raw::c_void,
    {
        unsafe { storage::TexImage3D = FnPtr::new(metaloadfn(&mut loadfn, "glTexImage3D", &[])) }
    }
}
...
pub mod TexStorage2D {
    ...
    {
        unsafe {
            storage::TexStorage2D = FnPtr::new(metaloadfn(&mut loadfn, "glTexStorage2D", &[]))
        }
    }
}
...
pub mod TexStorage2DMultisample {
    ...
    {
        unsafe {
            storage::TexStorage2DMultisample =
                FnPtr::new(metaloadfn(&mut loadfn, "glTexStorage2DMultisample", &[]))
        }
    }
}
...
pub mod TexStorage3D {
    ...
    {
        unsafe {
            storage::TexStorage3D = FnPtr::new(metaloadfn(&mut loadfn, "glTexStorage3D", &[]))
        }
    }
}
...
pub mod TexSubImage3D {
    ...
    {
        unsafe {
            storage::TexSubImage3D = FnPtr::new(metaloadfn(&mut loadfn, "glTexSubImage3D", &[]))
        }
    }
}
...
pub mod TransformFeedbackVaryings {
    ...
    {
        unsafe {
            storage::TransformFeedbackVaryings =
                FnPtr::new(metaloadfn(&mut loadfn, "glTransformFeedbackVaryings", &[]))
        }
    }
}
...
pub mod Uniform1f {
    ...
    where
        F: FnMut(&'static str) -> *const raw::c_void,
    {
        unsafe { storage::Uniform1f = FnPtr::new(metaloadfn(&mut loadfn, "glUniform1f", &[])) }
    }
}
...
pub mod Uniform1fv {
    ...
    where
        F: FnMut(&'static str) -> *const raw::c_void,
    {
        unsafe { storage::Uniform1fv = FnPtr::new(metaloadfn(&mut loadfn, "glUniform1fv", &[])) }
    }
}
...
pub mod Uniform1i {
    ...
    where
        F: FnMut(&'static str) -> *const raw::c_void,
    {
        unsafe { storage::Uniform1i = FnPtr::new(metaloadfn(&mut loadfn, "glUniform1i", &[])) }
    }
}
...
pub mod Uniform1iv {
    ...
    where
        F: FnMut(&'static str) -> *const raw::c_void,
    {
        unsafe { storage::Uniform1iv = FnPtr::new(metaloadfn(&mut loadfn, "glUniform1iv", &[])) }
    }
}
...
pub mod Uniform1ui {
    ...
    where
        F: FnMut(&'static str) -> *const raw::c_void,
    {
        unsafe { storage::Uniform1ui = FnPtr::new(metaloadfn(&mut loadfn, "glUniform1ui", &[])) }
    }
}
...
pub mod Uniform1uiv {
    ...
    where
        F: FnMut(&'static str) -> *const raw::c_void,
    {
        unsafe { storage::Uniform1uiv = FnPtr::new(metaloadfn(&mut loadfn, "glUniform1uiv", &[])) }
    }
}
...
pub mod Uniform2f {
    ...
    where
        F: FnMut(&'static str) -> *const raw::c_void,
    {
        unsafe { storage::Uniform2f = FnPtr::new(metaloadfn(&mut loadfn, "glUniform2f", &[])) }
    }
}
...
pub mod Uniform2fv {
    ...
    where
        F: FnMut(&'static str) -> *const raw::c_void,
    {
        unsafe { storage::Uniform2fv = FnPtr::new(metaloadfn(&mut loadfn, "glUniform2fv", &[])) }
    }
}
...
pub mod Uniform2i {
    ...
    where
        F: FnMut(&'static str) -> *const raw::c_void,
    {
        unsafe { storage::Uniform2i = FnPtr::new(metaloadfn(&mut loadfn, "glUniform2i", &[])) }
    }
}
...
pub mod Uniform2iv {
    ...
    where
        F: FnMut(&'static str) -> *const raw::c_void,
    {
        unsafe { storage::Uniform2iv = FnPtr::new(metaloadfn(&mut loadfn, "glUniform2iv", &[])) }
    }
}
...
pub mod Uniform2ui {
    ...
    where
        F: FnMut(&'static str) -> *const raw::c_void,
    {
        unsafe { storage::Uniform2ui = FnPtr::new(metaloadfn(&mut loadfn, "glUniform2ui", &[])) }
    }
}
...
pub mod Uniform2uiv {
    ...
    where
        F: FnMut(&'static str) -> *const raw::c_void,
    {
        unsafe { storage::Uniform2uiv = FnPtr::new(metaloadfn(&mut loadfn, "glUniform2uiv", &[])) }
    }
}
...
pub mod Uniform3f {
    ...
    where
        F: FnMut(&'static str) -> *const raw::c_void,
    {
        unsafe { storage::Uniform3f = FnPtr::new(metaloadfn(&mut loadfn, "glUniform3f", &[])) }
    }
}
...
pub mod Uniform3fv {
    ...
    where
        F: FnMut(&'static str) -> *const raw::c_void,
    {
        unsafe { storage::Uniform3fv = FnPtr::new(metaloadfn(&mut loadfn, "glUniform3fv", &[])) }
    }
}
...
pub mod Uniform3i {
    ...
    where
        F: FnMut(&'static str) -> *const raw::c_void,
    {
        unsafe { storage::Uniform3i = FnPtr::new(metaloadfn(&mut loadfn, "glUniform3i", &[])) }
    }
}
...
pub mod Uniform3iv {
    ...
    where
        F: FnMut(&'static str) -> *const raw::c_void,
    {
        unsafe { storage::Uniform3iv = FnPtr::new(metaloadfn(&mut loadfn, "glUniform3iv", &[])) }
    }
}
...
pub mod Uniform3ui {
    ...
    where
        F: FnMut(&'static str) -> *const raw::c_void,
    {
        unsafe { storage::Uniform3ui = FnPtr::new(metaloadfn(&mut loadfn, "glUniform3ui", &[])) }
    }
}
...
pub mod Uniform3uiv {
    ...
    where
        F: FnMut(&'static str) -> *const raw::c_void,
    {
        unsafe { storage::Uniform3uiv = FnPtr::new(metaloadfn(&mut loadfn, "glUniform3uiv", &[])) }
    }
}
...
pub mod Uniform4f {
    ...
    where
        F: FnMut(&'static str) -> *const raw::c_void,
    {
        unsafe { storage::Uniform4f = FnPtr::new(metaloadfn(&mut loadfn, "glUniform4f", &[])) }
    }
}
...
pub mod Uniform4fv {
    ...
    where
        F: FnMut(&'static str) -> *const raw::c_void,
    {
        unsafe { storage::Uniform4fv = FnPtr::new(metaloadfn(&mut loadfn, "glUniform4fv", &[])) }
    }
}
...
pub mod Uniform4i {
    ...
    where
        F: FnMut(&'static str) -> *const raw::c_void,
    {
        unsafe { storage::Uniform4i = FnPtr::new(metaloadfn(&mut loadfn, "glUniform4i", &[])) }
    }
}
...
pub mod Uniform4iv {
    ...
    where
        F: FnMut(&'static str) -> *const raw::c_void,
    {
        unsafe { storage::Uniform4iv = FnPtr::new(metaloadfn(&mut loadfn, "glUniform4iv", &[])) }
    }
}
...
pub mod Uniform4ui {
    ...
    where
        F: FnMut(&'static str) -> *const raw::c_void,
    {
        unsafe { storage::Uniform4ui = FnPtr::new(metaloadfn(&mut loadfn, "glUniform4ui", &[])) }
    }
}
...
pub mod Uniform4uiv {
    ...
    where
        F: FnMut(&'static str) -> *const raw::c_void,
    {
        unsafe { storage::Uniform4uiv = FnPtr::new(metaloadfn(&mut loadfn, "glUniform4uiv", &[])) }
    }
}
...
pub mod UniformBlockBinding {
    ...
    {
        unsafe {
            storage::UniformBlockBinding =
                FnPtr::new(metaloadfn(&mut loadfn, "glUniformBlockBinding", &[]))
        }
    }
}
...
pub mod UniformMatrix2fv {
    ...
    {
        unsafe {
            storage::UniformMatrix2fv =
                FnPtr::new(metaloadfn(&mut loadfn, "glUniformMatrix2fv", &[]))
        }
    }
}
...
pub mod UniformMatrix2x3fv {
    ...
    {
        unsafe {
            storage::UniformMatrix2x3fv =
                FnPtr::new(metaloadfn(&mut loadfn, "glUniformMatrix2x3fv", &[]))
        }
    }
}
...
pub mod UniformMatrix2x4fv {
    ...
    {
        unsafe {
            storage::UniformMatrix2x4fv =
                FnPtr::new(metaloadfn(&mut loadfn, "glUniformMatrix2x4fv", &[]))
        }
    }
}
...
pub mod UniformMatrix3fv {
    ...
    {
        unsafe {
            storage::UniformMatrix3fv =
                FnPtr::new(metaloadfn(&mut loadfn, "glUniformMatrix3fv", &[]))
        }
    }
}
...
pub mod UniformMatrix3x2fv {
    ...
    {
        unsafe {
            storage::UniformMatrix3x2fv =
                FnPtr::new(metaloadfn(&mut loadfn, "glUniformMatrix3x2fv", &[]))
        }
    }
}
...
pub mod UniformMatrix3x4fv {
    ...
    {
        unsafe {
            storage::UniformMatrix3x4fv =
                FnPtr::new(metaloadfn(&mut loadfn, "glUniformMatrix3x4fv", &[]))
        }
    }
}
...
pub mod UniformMatrix4fv {
    ...
    {
        unsafe {
            storage::UniformMatrix4fv =
                FnPtr::new(metaloadfn(&mut loadfn, "glUniformMatrix4fv", &[]))
        }
    }
}
...
pub mod UniformMatrix4x2fv {
    ...
    {
        unsafe {
            storage::UniformMatrix4x2fv =
                FnPtr::new(metaloadfn(&mut loadfn, "glUniformMatrix4x2fv", &[]))
        }
    }
}
...
pub mod UniformMatrix4x3fv {
    ...
    {
        unsafe {
            storage::UniformMatrix4x3fv =
                FnPtr::new(metaloadfn(&mut loadfn, "glUniformMatrix4x3fv", &[]))
        }
    }
}
...
pub mod UnmapBuffer {
    ...
    where
        F: FnMut(&'static str) -> *const raw::c_void,
    {
        unsafe { storage::UnmapBuffer = FnPtr::new(metaloadfn(&mut loadfn, "glUnmapBuffer", &[])) }
    }
}
...
pub mod UseProgram {
    ...
    where
        F: FnMut(&'static str) -> *const raw::c_void,
    {
        unsafe { storage::UseProgram = FnPtr::new(metaloadfn(&mut loadfn, "glUseProgram", &[])) }
    }
}
...
pub mod UseProgramStages {
    ...
    {
        unsafe {
            storage::UseProgramStages =
                FnPtr::new(metaloadfn(&mut loadfn, "glUseProgramStages", &[]))
        }
    }
}
...
pub mod ValidateProgram {
    ...
    {
        unsafe {
            storage::ValidateProgram = FnPtr::new(metaloadfn(&mut loadfn, "glValidateProgram", &[]))
        }
    }
}
...
pub mod ValidateProgramPipeline {
    ...
    {
        unsafe {
            storage::ValidateProgramPipeline =
                FnPtr::new(metaloadfn(&mut loadfn, "glValidateProgramPipeline", &[]))
        }
    }
}
...
pub mod VertexAttrib1f {
    ...
    {
        unsafe {
            storage::VertexAttrib1f = FnPtr::new(metaloadfn(&mut loadfn, "glVertexAttrib1f", &[]))
        }
    }
}
...
pub mod VertexAttrib1fv {
    ...
    {
        unsafe {
            storage::VertexAttrib1fv = FnPtr::new(metaloadfn(&mut loadfn, "glVertexAttrib1fv", &[]))
        }
    }
}
...
pub mod VertexAttrib2f {
    ...
    {
        unsafe {
            storage::VertexAttrib2f = FnPtr::new(metaloadfn(&mut loadfn, "glVertexAttrib2f", &[]))
        }
    }
}
...
pub mod VertexAttrib2fv {
    ...
    {
        unsafe {
            storage::VertexAttrib2fv = FnPtr::new(metaloadfn(&mut loadfn, "glVertexAttrib2fv", &[]))
        }
    }
}
...
pub mod VertexAttrib3f {
    ...
    {
        unsafe {
            storage::VertexAttrib3f = FnPtr::new(metaloadfn(&mut loadfn, "glVertexAttrib3f", &[]))
        }
    }
}
...
pub mod VertexAttrib3fv {
    ...
    {
        unsafe {
            storage::VertexAttrib3fv = FnPtr::new(metaloadfn(&mut loadfn, "glVertexAttrib3fv", &[]))
        }
    }
}
...
pub mod VertexAttrib4f {
    ...
    {
        unsafe {
            storage::VertexAttrib4f = FnPtr::new(metaloadfn(&mut loadfn, "glVertexAttrib4f", &[]))
        }
    }
}
...
pub mod VertexAttrib4fv {
    ...
    {
        unsafe {
            storage::VertexAttrib4fv = FnPtr::new(metaloadfn(&mut loadfn, "glVertexAttrib4fv", &[]))
        }
    }
}
...
pub mod VertexAttribBinding {
    ...
    {
        unsafe {
            storage::VertexAttribBinding =
                FnPtr::new(metaloadfn(&mut loadfn, "glVertexAttribBinding", &[]))
        }
    }
}
...
pub mod VertexAttribDivisor {
    ...
    {
        unsafe {
            storage::VertexAttribDivisor =
                FnPtr::new(metaloadfn(&mut loadfn, "glVertexAttribDivisor", &[]))
        }
    }
}
...
pub mod VertexAttribFormat {
    ...
    {
        unsafe {
            storage::VertexAttribFormat =
                FnPtr::new(metaloadfn(&mut loadfn, "glVertexAttribFormat", &[]))
        }
    }
}
...
pub mod VertexAttribI4i {
    ...
    {
        unsafe {
            storage::VertexAttribI4i = FnPtr::new(metaloadfn(&mut loadfn, "glVertexAttribI4i", &[]))
        }
    }
}
...
pub mod VertexAttribI4iv {
    ...
    {
        unsafe {
            storage::VertexAttribI4iv =
                FnPtr::new(metaloadfn(&mut loadfn, "glVertexAttribI4iv", &[]))
        }
    }
}
...
pub mod VertexAttribI4ui {
    ...
    {
        unsafe {
            storage::VertexAttribI4ui =
                FnPtr::new(metaloadfn(&mut loadfn, "glVertexAttribI4ui", &[]))
        }
    }
}
...
pub mod VertexAttribI4uiv {
    ...
    {
        unsafe {
            storage::VertexAttribI4uiv =
                FnPtr::new(metaloadfn(&mut loadfn, "glVertexAttribI4uiv", &[]))
        }
    }
}
...
pub mod VertexAttribIFormat {
    ...
    {
        unsafe {
            storage::VertexAttribIFormat =
                FnPtr::new(metaloadfn(&mut loadfn, "glVertexAttribIFormat", &[]))
        }
    }
}
...
pub mod VertexAttribIPointer {
    ...
    {
        unsafe {
            storage::VertexAttribIPointer =
                FnPtr::new(metaloadfn(&mut loadfn, "glVertexAttribIPointer", &[]))
        }
    }
}
...
pub mod VertexAttribPointer {
    ...
    {
        unsafe {
            storage::VertexAttribPointer =
                FnPtr::new(metaloadfn(&mut loadfn, "glVertexAttribPointer", &[]))
        }
    }
}
...
pub mod VertexBindingDivisor {
    ...
    {
        unsafe {
            storage::VertexBindingDivisor =
                FnPtr::new(metaloadfn(&mut loadfn, "glVertexBindingDivisor", &[]))
        }
    }
}
...
pub mod WaitSync {
    ...
    where
        F: FnMut(&'static str) -> *const raw::c_void,
    {
        unsafe { storage::WaitSync = FnPtr::new(metaloadfn(&mut loadfn, "glWaitSync", &[])) }
    }
}
